...
<div class="container register-container">
    ...
    <div class="card register-card">
        ...
        <div class="card-body p-4">
			...
			<%--instead of form, here we use form:form and specify modelAttribute --%>
            <form:form action="/formbinding2Way/register" method="post" modelAttribute="stu">
                ...
                <div class="mb-3">
					...
					<%--here for input instead of input, we use form:input --%>
                    <form:input 
                    	   path="sid"
                           class="form-control"
                           id="sid"                           
